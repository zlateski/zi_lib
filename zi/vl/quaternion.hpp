...
public:
    ...
    explicit quaternion( T const & _x = T(),
                         T const & _y = T(),
                         T const & _z = T(),
                         T const & _w = T() )
    ...
    {
        return quaternion< type >( static_cast< type >( 0 ), y_, z_, w_ );
    }

    type real_part_1() const
    {
        return x_;
    }

    type real_part_2() const
    {
        return y_;
    }

    type real_part_3() const
    {
        return z_;
    }

    type real_part_4() const
    {
        return w_;
    }
    ...
    ::std::complex< type > complex_part_1() const
    {
        return ::std::complex< type >( x_, y_ );
    }

    ::std::complex< type > complex_part_2() const
    {
        return ::std::complex< type >( z_, w_ );
    }

    template< class X >
    quaternion< type >& operator=( quaternion< X > const & other )
    {
        x_ = static_cast< type >( other.x() );
        y_ = static_cast< type >( other.y() );
        z_ = static_cast< type >( other.z() );
        w_ = static_cast< type >( other.w() );
        return *this;
    }

    quaternion< type >& operator=( quaternion< type > const & other )
    {
        x_ = other.x_;
        y_ = other.y_;
        z_ = other.z_;
    ...
    quaternion< type >& operator=( type const * x )
    {
        x_ = x;
        y_ = z_ = w_ = static_cast< type >( 0 );
        return *this;
    }

    quaternion< type >& operator=( ::std::complex< type > const & c )
    {
        x_ = c.real();
        y_ = c.imag();
        z_ = w_ = static_cast< type >( 0 );
        return *this;
    }

    quaternion< T > & operator+=( T const & v )
    {
        T _x = x_ + v;
        x_ = _x;
        return *this;
    ...
    quaternion< T > & operator+=( ::std::complex< T > const & v )
    {
        T _x = x_ + v.real();
        T _y = y_ + v.imag();
        x_ = _x;
    ...
    template< class X >
    quaternion< T > & operator+=( quaternion< X > const & q )
    {
        T _x = x_ + static_cast< T >( q.x() );
        T _y = y_ + static_cast< T >( q.y() );
        T _z = z_ + static_cast< T >( q.z() );
        T _w = w_ + static_cast< T >( q.w() );
        x_ = _x;
        y_ = _y;
        return *this;
    }
    ...
    quaternion< T > & operator*=( quaternion< X > const & q )
    {
        T xr = static_cast< T >( q.x() );
        T yr = static_cast< T >( q.y() );
        T zr = static_cast< T >( q.z() );
        T wr = static_cast< T >( q.w() );

        T _x = +x*xr-y*yr-z*zr-w*wr;
        T _y = +x*yr+y*xr+z*wr-w*zr;
        T _z = +x*zr-y*wr+z*xr+w*yr;
        T _w = +x*wr+y*zr-z*yr+w*xr;
