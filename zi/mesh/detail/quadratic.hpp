...
#undef ZI_QUADRATIC_COMPOUND_OPERATOR
    ...
    template< class Y >
    inline T operator()( const zi::vl::vec< Y, 3 >& v ) const
    {
        return evaluate( v.at( 0 ), v.at( 1 ), v.at( 2 ) );
    }

    inline T operator()( const zi::vl::vec< T, 3 >& v ) const
    {
        return evaluate( v.at( 0 ), v.at( 1 ), v.at( 2 ) );
    }

    inline zi::vl::mat< T, 3 > tensor() const
    {
        return zi::vl::mat< T, 3 >( a2, ab, ac, ab, b2, bc, ac, bc, c2 );
    }

    inline zi::vl::mat< T, 4 > homogenous() const
    {
    ...
    inline bool optimize( zi::vl::vec< T, 3 >& v ) const
    {
