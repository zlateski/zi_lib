...
#ifndef ZI_WATERSHED_DETAIL_AUTO_MAPPED_VECTOR_HPP
#define ZI_WATERSHED_DETAIL_AUTO_MAPPED_VECTOR_HPP 1

#include <zi/watershed/detail/io_semaphore.hpp>
...
class auto_mapped_vector: non_copyable
{
private:
    std::size_t size_           ;
